...
namespace RecordCollection.DAO
{
    public class DataForScriptSqlDao : IDataForScript
    {
        ...
        public string GetSinglesValuesForScript()
        {
            string sqlValuesString = "INSERT INTO singles (file_as, artist, title, release_year, record_label, issue_year, " +
    "serial_number, pressing, color, notes) VALUES ";
